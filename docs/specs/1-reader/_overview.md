...
- **ReaderLocator** {chapterId, blockId, textOffset} — a point position. **ReaderRangeLocator** — a selection range with contextBefore/After fallback. Defined once in spec 1.4; other specs reference it.
